...
## set the directory to the folder named "getdata_projectfiles_UCI HAR Dataset"
## this folder contains all the files required for the following cleaning steps


## load all files belonging to the training dataset
...
## load all files belonging to the test dataset
...
## load the features and its estimated variables names 
...
## from the dataset on mean and stardard deviation, create a second and independent tidy data set with the average of 
...
## export the data in a text format 
